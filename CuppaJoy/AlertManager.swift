...
struct AlertItem: Identifiable {
  ...
  // Simple alert with just a dismiss button
  init(
    _ title: Text,
    _ message: Text? = nil,
  ...
  // Alert with primary and secondary buttons for custom actions
  init(
    _ title: Text,
    _ message: Text? = nil,
...
// Extension to create the actual alert from AlertItem
extension AlertItem {
  var alert: Alert {
...
struct AuthenticationAlertContext {
  
  // Create an alert with custom actions
  static func passwordResetConfirmation(onConfirm: @escaping () -> Void) -> AlertItem {
    AlertItem(
      Text("Password Reset"),
      Text("Are you sure you want to reset your password?"),
      primaryButton: .destructive(Text("Reset Password"), action: onConfirm),
